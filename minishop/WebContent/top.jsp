...
<link rel="stylesheet" href="/minishop/common/css/lavalamp_test.css" type="text/css">
<script type="text/javascript" src="/minishop/common/js/jquery.js"></script>
<script type="text/javascript" src="/minishop/common/js/jquery.lavalamp.js"></script>
<script type="text/javascript" src="/minishop/common/js/jquery.easing.js"></script> 
...
<body>
	...
	<a href="#">회원가입</a></h5>
			...
			<h5 style="float: right; margin-left: 10px">
		<a href="/minishop/member/login.jsp">로그인</a></h5>
